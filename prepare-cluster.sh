...
oc apply -k https://raw.githubusercontent/cloud-native-toolkit/deployer-cluster-prep/argocd-operator --insecure-skip-tls-verify=true
...
oc apply -k https://raw.githubusercontent/cloud-native-toolkit/deployer-cluster-prep/argocd-instance --insecure-skip-tls-verify=true

# install OpenShift Pipelines
oc apply -k https://raw.githubusercontent/cloud-native-toolkit/deployer-cluster-prep/openshift-pipelines-operator --insecure-skip-tls-verify=true

# install external secrets operator
oc apply -k https://raw.githubusercontent/cloud-native-toolkit/deployer-cluster-prep/externalsecrets-operator --insecure-skip-tls-verify=true
