...
# Add dynamic plugin 
 oc apply -f https://raw.githubusercontent.com/cloud-native-toolkit/deployer-cluster-prep/f63008432b5966339e886c362ad205c75c98fd8e/dynamic-plugin/deployer-plugin.yaml --insecure-skip-tls-verify=true 