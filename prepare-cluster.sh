...
oc wait crd applications.argoproj.io --timeout=1800s --for=condition=Established  --insecure-skip-tls-verify=true
sleep 5
...
oc wait pod -l '!job-name' -n openshift-gitops --timeout=1800s --for=condition=Ready  --insecure-skip-tls-verify=true
...
#while ! oc wait crd pipelines.tekton.dev --timeout=-1s --for=condition=Established  --insecure-skip-tls-verify=true  2>/dev/null; do sleep 30; done
...
oc wait crd pipelines.tekton.dev --timeout=1800s --for=condition=Established  --insecure-skip-tls-verify=true
oc wait crd pipelineruns.tekton.dev --timeout=1800s --for=condition=Established  --insecure-skip-tls-verify=true
oc wait crd tasks.tekton.dev --timeout=1800s --for=condition=Established  --insecure-skip-tls-verify=true
oc wait TektonPipelines/pipeline --for=condition=ready  --timeout=1800s --insecure-skip-tls-verify=true
oc wait TektonAddon/addon --for=condition=Ready  --timeout=1800s --insecure-skip-tls-verify=true
...
oc wait crd clustersecretstores.external-secrets.io --timeout=1800s --for=condition=Established --insecure-skip-tls-verify=true
oc wait crd externalsecrets.external-secrets.io --timeout=1800s --for=condition=Established --insecure-skip-tls-verify=true
oc wait crd operatorconfigs.operator.external-secrets.io --timeout=1800s --for=condition=Established --insecure-skip-tls-verify=true
